...
<p style="font-size:16px"> <strong style="font-weight:bold">When you use <span style="color:red; font-weight: bold;"> WCFM marketplace </span>in your store, you can trial during 7 days SCD premium variant for WCFM. <a href="https://downloads.wordpress.org/plugin/scd-smart-currency-detector-variant-for-wcfm.zip" > Download here </a> ,if you have not yet installed . </strong></p>
...
<p style="font-size:18px"><img src="<?php echo $scd_free_icon; ?>"><strong>&emsp;SMART CURRENCY DETECTOR </strong>.</p>
<p style="font-size:16px"> Thank you for installing the free variant of our end2end currencies handler plugin SCD.</p>
<p style="font-size:16px"> <strong style="font-weight:bold">When you use <span style="color:red; font-weight: bold;"> Dokan marketplace </span>in your store, you can trial during 7 days SCD premium variant for Dokan. <a href="https://downloads.wordpress.org/plugin/scd-smart-currency-detector-variant-for-dokan.zip" > Download here </a> ,if you have not yet installed . </strong></p>
...
<p style="font-size:18px"><img src="<?php echo $scd_free_icon; ?>"><strong>&emsp;SMART CURRENCY DETECTOR </strong>.</p>
<p style="font-size:16px"> Thank you for installing the free variant of our end2end currencies handler plugin SCD.</p>
<p style="font-size:16px"> <strong style="font-weight:bold">When you use <span style="color:red; font-weight: bold;"> WCMP marketplace </span>in your store, you can trial during 7 days SCD premium variant for WCMP. <a href="https://drive.google.com/uc?id=1jODyzt78xfVn7b65kFA3YREIvB0TyqjV&export=download" > Download here </a> ,if you have not yet installed . </strong></p>
...
<p style="font-size:18px"><img src="<?php echo $scd_free_icon; ?>"><strong>&emsp;SMART CURRENCY DETECTOR </strong>.</p>
<p style="font-size:16px"> Thank you for installing the free variant of our end2end currencies handler plugin SCD.</p>
<p style="font-size:16px"> <strong style="font-weight:bold">When you use <span style="color:red; font-weight: bold;"> WC-Vendor marketplace </span>in your store, you can trial during 7 days SCD premium variant for WC-Vendor. <a href="https://drive.google.com/uc?id=1fyc7BarON0isuxuzqVFichMQQVn8GXbh&export=download" > Download here </a> ,if you have not yet installed . </strong></p>
...
function scd_feedback() {
	  ...
	  $subject = "SCD Free 4.8.0 new desactivated";
  ...
  foreach($fields as $key=>$value) { 
    if ($value != "") {
	  ...
	  if(is_plugin_active('wc-multivendor-marketplace/wc-multivendor-marketplace.php')){
		  ...
		  $marketplace = "WCMP";
	  }elseif(is_plugin_active('wc-vendors/class-wc-vendors.php')){
		  $marketplace = "WC-VENDOR";
	  }else {
		  $marketplace = "RAS";
	  } 
...
function scd_feedback_javascript() { ?>
	                   ...
	                   buttons: [
...

	                       {
	                         ...
	                         click: function() {
	                                    ...
	                                    window.open('https://wordpress.org/support/plugin/scd-smart-currency-detector/');
	...
	function plugin_activated()
	{
	  ...
	  $subject = "Smart-Currency-Detector 4.8.0 new activation";
	  ...
	  $message = 'new customer website - ' . $_SERVER['HTTP_HOST'] . ' - customer email - ' . $user_email . ' - customer name - ' . $firstname . ' - Marketplace - ' . $marketplace ;
    ...
    function plugin_deactivated()
	{
	  ...
	  $subject = "Smart-Currency-Detector 4.8.0 New Deactivation";
